package fun.deepsky.javamicroservice.book.controller;
...
import fun.deepsky.javamicroservice.book.service.BookingService;
import fun.deepsky.javamicroservice.book.vo.BookingVO;

@Controller
@RequestMapping("/booking")
public class BookingServiceController {

	protected static final Logger logger = Logger.getLogger(BookingServiceController.class.getName());
